...
abstract contract ERC725Y is OwnableUnset, IERC725Y {
     ...
     * @inheritdoc IERC725Y
     */
    function getDataBatch(bytes32[] memory dataKeys) public view virtual override returns (bytes[] memory dataValues) {
    ...
    function supportsInterface(bytes4 interfaceId) public view virtual returns (bool) {
        return interfaceId == 0x629aa694 || interfaceId == 0x01ffc9a7;
    }
}
