...
import {LSP7SafeTransferLib} from '../libraries/LSP7SafeTransferLib.sol';
...
abstract contract Payments is PaymentsImmutables {
    using LSP7SafeTransferLib for ERC20;
    using LSP7SafeTransferLib for address;
    ...
    function wrapETH(address recipient, uint256 amount) internal {
        ...
        if (amount > 0) {
            ...
            if (recipient != address(this)) {
                WETH9.transfer(address(this), recipient, amount, true, '');
            }
        }
    }
